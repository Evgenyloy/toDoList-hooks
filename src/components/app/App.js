...
const App = () => {
  const [currentMonth] = useState(
    new window.Date().toLocaleString('eng', { month: 'short' })
  )
  const [currentDay] = useState(new window.Date().getDate().toLocaleString())
  ...
  return (
    <div className="container">
      <div className="todo">
        <Date currentMonth={currentMonth} currentDay={currentDay} />
